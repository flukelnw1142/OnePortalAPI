...
namespace OnePortal_Api.Services
{
    public interface ISupplierService
    {
        ...
        Task<Supplier> UpdateSupplier(int id, SupplierDto supplierDto, CancellationToken cancellationToken = default); // เพิ่ม method นี้
        ...
        Task<Supplier> GetDataByTaxID(string taxId, CancellationToken cancellationToken = default);
        ...
        Task<List<Supplier>> GetDataByUserCompanyACC(string company, CancellationToken cancellationToken = default);
